        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checks_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationChannels_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkspaceGroupMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkspaceGroupMappings_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    TriggerOnWarn = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    TriggerOnDown = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    FailureThreshold = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    SendRecoveryNotification = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventSubscriptions_NotificationChannels_NotificationChannel~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlertHistories_NotificationChannels_NotificationChannelId",
                        column: x => x.NotificationChannelId,
                        principalTable: "NotificationChannels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationChannelMappings", x => new { x.AlertId, x.NotificationChannelId });
                    table.ForeignKey(
                        name: "FK_NotificationChannelMappings_Alerts_AlertId",
                        column: x => x.AlertId,
                        principalTable: "Alerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationChannelMappings_NotificationChannels_Notificati~",
                        column: x => x.NotificationChannelId,
                        principalTable: "NotificationChannels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertHistory_AlertId_SentAt",
                table: "AlertHistories",
                columns: new[] { "AlertId", "SentAt" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "IX_AlertHistory_NotificationChannelId",
                table: "AlertHistories",
                column: "NotificationChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_AlertHistory_TriggerEventId",
                table: "AlertHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventSubscriptions_NotificationChannelId",
                table: "EventSubscriptions",
                column: "NotificationChannelId");

            migrationBuilder.CreateIndex(
                name: "UX_EventSubscriptions_Subscription",
                table: "EventSubscriptions",
                columns: new[] { "NotificationChannelId", "EventType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NotificationChannelMappings_NotificationChannelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationChannels_WorkspaceId",
                table: "NotificationChannels",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserWorkspaces_Source",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkspaceGroupMappings_WorkspaceId",
                table: "WorkspaceGroupMappings",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "UX_WorkspaceGroupMappings_Mapping",
                table: "WorkspaceGroupMappings",
                columns: new[] { "WorkspaceId", "IdentityProvider", "ExternalGroupId" },
                unique: true);
